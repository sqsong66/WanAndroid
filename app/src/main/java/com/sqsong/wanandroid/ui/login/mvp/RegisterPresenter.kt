...
class RegisterPresenter @Inject constructor(private val registerView: RegisterContract.View,
    ...
    private fun registerEvents() {
        ...
        addDisposable(mView?.backDisposable())
        addDisposable(mView?.userNameDisposable())
        addDisposable(mView?.passwordDisposable())
        addDisposable(mView?.confirmPasswordDisposable())
        registerCommitEvent()
    }
